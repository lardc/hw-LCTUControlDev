...
GPIO_PortPinSettingMacro GPIO_OPAMP_R0			= {GPIOB, Pin_1};
GPIO_PortPinSettingMacro GPIO_OPAMP_R1			= {GPIOA, Pin_7};
GPIO_PortPinSettingMacro GPIO_OPAMP_R2			= {GPIOB, Pin_0};
